...
namespace AutoShop.Data.Mocks
{
    ...
    {
        private readonly ICarsCategory _categoriesCar;
        ...
        public Car GetObjectCar(int carId) => Cars.First(c => c.Id == carId);

        public MockCar(ICarsCategory categoriesCar)
        {
            _categoriesCar = categoriesCar;
        }
